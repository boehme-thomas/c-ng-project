...
/**
 * \file
 *         The final project, for usage with the statistics module and the server. Used for the dongle boards.
 * \author
 *         Thomas Böhme
 *
 */
...
#include "arch/dev/etc/rgb-led/rgb-led.h"
...
/*---------------------------------------------------------------------------*/
PROCESS(final_example_dongle, "Final running example for dongles");
AUTOSTART_PROCESSES(&final_example_dongle);
...
/*---------------------------------------------------------------------------*/
PROCESS_THREAD(final_example_dongle, ev, data) {
